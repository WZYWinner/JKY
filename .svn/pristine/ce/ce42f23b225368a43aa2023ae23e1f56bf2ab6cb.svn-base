<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="GoodsList_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.LqAdmin.GoodsListModify" %>
...
<tbody>
<tr> <td  title ="商品名" colspan ="3"><span class="col_name">商品名：</span><asp:TextBox ID="tbGoodsName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="商品图片" colspan ="3"><span class="col_name">商品图片：</span><asp:TextBox ID="tbGoodsLogo" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
