<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="GoodsList_Create.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.GoodsListCreate" %>
...
<h4 class="txt_title" style="float: left">新增商品列表</h4>
