<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MerchantClassifyList.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.LqAdmin.MerchantClassifyList" ValidateRequest="false" %>
