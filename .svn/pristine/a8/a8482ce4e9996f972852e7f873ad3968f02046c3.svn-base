<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="MerchantClassify_Create.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.LqAdmin.MerchantClassifyCreate" %>
