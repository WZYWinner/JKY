...
protected void DataInit()
{
 ...
 /////以下是有审批的业务逻辑
 /////以下是无审批的业务逻辑
 var result = Yaohuasoft.Framework.BLL.LqAdmin.GoodsClassifyBLL.ImportExcel2Db(dataTable,ImportExcelType.UseImport,Session["CorpId"].ToStr(),Session["DepartmentId"].ToStr(),Session["UserName"].ToStr());
