<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="SysUser_Create.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.SysUserCreate" %>
