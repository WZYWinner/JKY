<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="HuangUser_Create.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.HuangUserCreate" %>
<%@ Import Namespace="Yaohuasoft.Framework.Library" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<title>新增HUANG用户 | </title>
...
<h4 class="txt_title" style="float: left">新增HUANG用户</h4>
