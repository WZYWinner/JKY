<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="OrderDetail_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.WzyAdmin.OrderDetailModify" %>
...
<h4 class="txt_title" style="float: left">编辑订单明细</h4>
...
<a class="btn btn-primary" href="javascript:window.location.href='OrderDetail_Detail.aspx?&id=<%=HttpUtility.UrlEncode(Request["id"])%>&rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="订单号" colspan ="3"><span class="col_name">订单号：</span><asp:TextBox ID="tbOrderId" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="商品名称" colspan ="3"><span class="col_name">商品名称：</span><asp:TextBox ID="tbOrderName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr> <td  title ="商品单价" colspan ="2"><span class="col_name">商品单价：</span><asp:TextBox ID="tbOrderUnitPrice" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="商品数量" colspan ="2"><span class="col_name">商品数量：</span><asp:TextBox ID="tbOrderNum" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="商品小计" colspan ="2"><span class="col_name">商品小计：</span><asp:TextBox ID="tbOrderSubtotal" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
