<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="MerchantSort_Create.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.MerchantSortCreate" %>
