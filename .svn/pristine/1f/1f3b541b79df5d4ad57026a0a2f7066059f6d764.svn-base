...
{
public partial class LxcAddressCreate : System.Web.UI.Page
{
...
{
////CheckSession();
////LxcAddressCreateDataInit方法之前
DataInit();
////LxcAddressCreateDataInit方法之后
}
}
...
////LxcAddressCreate初始化替换代码之前
////LxcAddressCreate初始化替换代码之后
////LxcAddressCreate初始化自动填充之前
////LxcAddressCreate初始化自动填充之后
}
//////LxcAddressCreate自定义事件替换1
//////LxcAddressCreate自定义事件替换2
//////LxcAddressCreate自定义事件替换3
//////LxcAddressCreate自定义事件替换4
//////LxcAddressCreate自定义事件替换5
//////LxcAddressCreate自定义事件替换6
...
////LxcAddressCreate赋值之后保存
////LxcAddressCreate保存的处理之前
{
////LxcAddressCreate保存Add方法之前
var ret = Yaohuasoft.Framework.BLL.SysAdmin.LxcAddressBLL.Add(entity,Session["CorpId"].ToStr(),Session["DepartmentId"].ToStr(),Session["UserName"].ToStr());
if (ret > 0)
{
