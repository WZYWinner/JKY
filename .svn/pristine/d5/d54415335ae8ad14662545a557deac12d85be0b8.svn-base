<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MerchantList_Detail.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.LqAdmin.MerchantListDetail" %>
...
<tbody>
<tr> <td  title ="商家名称" colspan ="3"><span class="col_name">商家名称：</span><%=HttpUtility.HtmlEncode(entity.MerchantName.ToStr()) %></td><td  title ="商家LOGO" colspan ="3"><span class="col_name">商家LOGO：</span><%=HttpUtility.HtmlEncode(entity.MerchantLogo.ToStr()) %></td> </tr>
