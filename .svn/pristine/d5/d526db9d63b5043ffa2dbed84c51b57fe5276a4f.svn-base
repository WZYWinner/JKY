<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="CarouselOne_Create.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.CarouselOneCreate" %>
...
<h4 class="txt_title" style="float: left">新增轮播图一</h4>
