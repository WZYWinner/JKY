<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsSortList.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.GoodsSortList" ValidateRequest="false" %>
