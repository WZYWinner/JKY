<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="GuoMerchant_Create.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.GuoMerchantCreate" %>
...
<h4 class="txt_title" style="float: left">新增商家</h4>
