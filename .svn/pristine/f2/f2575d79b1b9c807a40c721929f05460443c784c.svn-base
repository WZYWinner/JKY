<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuoAddressList.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.GsfAdmin.GuoAddressList" ValidateRequest="false" %>
