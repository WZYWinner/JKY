<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="MzqGoods_Create.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.MzqGoodsCreate" %>
