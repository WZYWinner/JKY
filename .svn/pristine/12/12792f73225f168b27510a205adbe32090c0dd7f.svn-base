<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WzyAdmin.aspx.cs" Inherits="UI.DEMO.WzyAdmin" %>
...
<%--                        <div class="sidebar-nav main-nav">
                        ...
                        <div class="sidebar-nav main-nav">
                            ...
                            <ul style="" class="entrance-nav sidebar-trans">
<li class="nav-item ng-scope" title="订单" src="/WebUI/SysAdmin/OrderForm_List.aspx?&rnd=<%=YaohuaID.GenRandomInt()%>"><a class="ng-scope" href="javascript:void(0)"><div class="nav-icon"><span class="icon-yunxunizhuji"></span></div><span class="nav-title ng-binding">订单</span></a></li>
...
<%--                           <div class="sidebar-title" title="个人用户管理">
            ...
            <div class="viewFramework-product">
                ...
                <div class="viewFramework-product-body">
                    <iframe id="mainFrame" frameborder="0" runat="server" src="WzyAdminHomePage.aspx" style="height: 100%; width: 100%; border: 0px;"></iframe>
                </div>
            </div>
        </div>
    </div>
