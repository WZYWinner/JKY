<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsClassifyList.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.LqAdmin.GoodsClassifyList" ValidateRequest="false" %>
