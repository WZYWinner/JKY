<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="UserInfo_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.UserInfoModify" %>
...
<h4 class="txt_title" style="float: left">编辑用户信息</h4>
...
<a class="btn btn-primary" href="javascript:window.location.href='UserInfo_Detail.aspx?rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>&id=<%=HttpUtility.UrlEncode(Request["id"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="" colspan ="3"><span class="col_name">用户名：</span><asp:TextBox ID="tbName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="" colspan ="3"><span class="col_name">密码：</span><asp:TextBox ID="tbPwd" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr> <td  title ="" colspan ="2"><span class="col_name">头像：</span><input type="hidden" name="hidden_fileHead" class=""/><UC:UC_PluploadSingle PageType ="可写" ID="fileHead" runat="server" /><b></b></td><td  title ="" colspan ="2"><span class="col_name">密保手机号码：</span><asp:TextBox ID="tbTel" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="" colspan ="2"><span class="col_name">经验：</span><asp:TextBox ID="tbExperience" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr> <td  title ="" colspan ="6"><span class="col_name">最近修改时间：</span><asp:TextBox ID="tbEditTime" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
