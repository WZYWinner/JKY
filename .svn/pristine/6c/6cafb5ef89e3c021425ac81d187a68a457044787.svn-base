<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="GoodsList_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.GoodsListModify" %>
...
<h4 class="txt_title" style="float: left">编辑商品列表</h4>
...
<a class="btn btn-primary" href="javascript:window.location.href='GoodsList_Detail.aspx?&id=<%=HttpUtility.UrlEncode(Request["id"])%>&rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="商品ID" colspan ="2"><span class="col_name">商品ID：</span><asp:TextBox ID="tbGoodsListId" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="商品名" colspan ="2"><span class="col_name">商品名：</span><asp:TextBox ID="tbGoodsName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="商品图片" colspan ="2"><span class="col_name">商品图片：</span><asp:TextBox ID="tbGoodsLogo" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr> <td  title ="商品单价" colspan ="2"><span class="col_name">商品单价：</span><asp:TextBox ID="tbGoodsPrice" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="商品销量" colspan ="2"><span class="col_name">商品销量：</span><asp:TextBox ID="tbGoodsSales" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="商品数量" colspan ="2"><span class="col_name">商品数量：</span><asp:TextBox ID="tbGoodsSum" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr> <td  title ="商品分类ID" colspan ="6"><span class="col_name">商品分类ID：</span><asp:TextBox ID="tbGoodsSortId" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
