<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="GuoAddress_Create.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.GsfAdmin.GuoAddressCreate" %>
