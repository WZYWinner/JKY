<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsClassify_Detail.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.LqAdmin.GoodsClassifyDetail" %>
...
<tbody>
<tr> <td  title ="商品分类名" colspan ="3"><span class="col_name">商品分类名：</span><%=HttpUtility.HtmlEncode(entity.SortName.ToStr()) %></td><td  title ="商品分类ID" colspan ="3"><span class="col_name">商品分类ID：</span><%=HttpUtility.HtmlEncode(entity.MerchantListId.ToStr()) %></td> </tr>
</tbody>
</table>
</div>
</div>
