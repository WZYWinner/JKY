<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="LiuAddress_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.LiuAddressModify" %>
...
<h4 class="txt_title" style="float: left">编辑用户地址</h4>
...
<a class="btn btn-primary" href="javascript:window.location.href='LiuAddress_Detail.aspx?&id=<%=HttpUtility.UrlEncode(Request["id"])%>&rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="省份" colspan ="3"><span class="col_name">省份：</span><asp:TextBox ID="tbProvince" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="收货地址" colspan ="3"><span class="col_name">收货地址：</span><asp:TextBox ID="tbAddress" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr> <td  title ="收货人" colspan ="2"><span class="col_name">收货人：</span><asp:TextBox ID="tbReceiver" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="收货人电话" colspan ="2"><span class="col_name">收货人电话：</span><asp:TextBox ID="tbTelephone" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="标签" colspan ="2"><span class="col_name">标签：</span><asp:TextBox ID="tbLaber" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr> <td  title ="用户ID" colspan ="6"><span class="col_name">用户ID：</span><asp:TextBox ID="tbUserId" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
