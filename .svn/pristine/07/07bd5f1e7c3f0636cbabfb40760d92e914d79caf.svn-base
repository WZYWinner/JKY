<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="SysConfig_Create.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.SysConfigCreate" %>
<%@ Import Namespace="Yaohuasoft.Framework.Library" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<title>新增通用配置信息 | </title>
...
<h4 class="txt_title" style="float: left">新增通用配置信息</h4>
