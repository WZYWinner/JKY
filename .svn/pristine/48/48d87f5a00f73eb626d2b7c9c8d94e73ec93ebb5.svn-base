<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Salesman.aspx.cs" Inherits="UI.DEMO.Salesman" %>
            ...
            <div class="aliyun-console-topbar ng-isolate-scope">
                <div class="topbar-wrap topbar-clearfix">
                    <div class="topbar-head topbar-left">
                        ...
                        <!-- ngIf: versionGreaterThan1_3_21 -->
                        <a href="javascript:showRight('SalesmanHomePage.aspx')" class="topbar-home-link topbar-btn topbar-left ng-scope">
                ...
                <div type="full" class="sidebar-content">
                    ...
                    <div class="sidebar-inner ng-scope">
                        ...
                        <div class="sidebar-nav sidebar-nav-fold">
                            ...
                            <li class="nav-item ng-scope"    title="合同信息" src="/WebUI/Salesman/ContractInfo_List.aspx?rnd=<%=YaohuaID.GenRandomInt()%>"><a href="javascript:void(0)" class="sidebar-trans ng-scope"><div class="nav-icon sidebar-trans"><span class="icon-form"></span> </div><span class="nav-title ng-binding">合同信息</span></a></li>
                            <li class="nav-item ng-scope"    title="简易合同" src="/WebUI/Salesman/SimpleContract_List.aspx?rnd=<%=YaohuaID.GenRandomInt()%>"><a href="javascript:void(0)" class="sidebar-trans ng-scope"><div class="nav-icon sidebar-trans"><span class="icon-form"></span> </div><span class="nav-title ng-binding">简易合同</span></a></li>
                         ...
                         <div class="sidebar-nav sidebar-nav-fold">
                            ...
                            <ul style="" class="entrance-nav sidebar-trans">
                                <li class="nav-item ng-scope"    title="收费单" src="/WebUI/FinanceMan/ChargeBill_List.aspx?rnd=<%=YaohuaID.GenRandomInt()%>"><a href="javascript:void(0)" class="sidebar-trans ng-scope"><div class="nav-icon sidebar-trans"><span class="icon-form"></span> </div><span class="nav-title ng-binding">收费单</span></a></li>
                                <li class="nav-item ng-scope"    title="财务收费" src="/WebUI/FinanceMan/FinanceCharge_List.aspx?rnd=<%=YaohuaID.GenRandomInt()%>"><a href="javascript:void(0)" class="sidebar-trans ng-scope"><div class="nav-icon sidebar-trans"><span class="icon-form"></span> </div><span class="nav-title ng-binding">财务收费</span></a></li>
                                <li class="nav-item ng-scope"    title="实验通知单" src="/WebUI/FinanceMan/TestInformBill_List.aspx?rnd=<%=YaohuaID.GenRandomInt()%>"><a href="javascript:void(0)" class="sidebar-trans ng-scope"><div class="nav-icon sidebar-trans"><span class="icon-form"></span> </div><span class="nav-title ng-binding">实验通知单</span></a></li>
                                <li class="nav-item ng-scope"    title="实验收费" src="/WebUI/FinanceMan/TestCharge_List.aspx?rnd=<%=YaohuaID.GenRandomInt()%>"><a href="javascript:void(0)" class="sidebar-trans ng-scope"><div class="nav-icon sidebar-trans"><span class="icon-form"></span> </div><span class="nav-title ng-binding">实验收费</span></a></li>
                                <li class="nav-item ng-scope"    title="费用汇总" src="/WebUI/FinanceMan/CostGather_List.aspx?rnd=<%=YaohuaID.GenRandomInt()%>"><a href="javascript:void(0)" class="sidebar-trans ng-scope"><div class="nav-icon sidebar-trans"><span class="icon-form"></span> </div><span class="nav-title ng-binding">费用汇总</span></a></li>
                                </ul>
                        </div>
                        <div class="sidebar-nav sidebar-nav-fold">
                            ...
                            <ul style="" class="entrance-nav sidebar-trans">
                                <li class="nav-item ng-scope"    title="客户管理" src="/WebUI/FinanceMan/CustManage_List.aspx?rnd=<%=YaohuaID.GenRandomInt()%>"><a href="javascript:void(0)" class="sidebar-trans ng-scope"><div class="nav-icon sidebar-trans"><span class="icon-form"></span> </div><span class="nav-title ng-binding">客户管理</span></a></li>
                                <li class="nav-item ng-scope"    title="客户账户" src="/WebUI/FinanceMan/CustAccount_List.aspx?rnd=<%=YaohuaID.GenRandomInt()%>"><a href="javascript:void(0)" class="sidebar-trans ng-scope"><div class="nav-icon sidebar-trans"><span class="icon-form"></span> </div><span class="nav-title ng-binding">客户账户</span></a></li>
                                    <li class="nav-item ng-scope"    title="账户结算" src="/WebUI/FinanceMan/AccountSettlement_List.aspx?rnd=<%=YaohuaID.GenRandomInt()%>"><a href="javascript:void(0)" class="sidebar-trans ng-scope"><div class="nav-icon sidebar-trans"><span class="icon-form"></span> </div><span class="nav-title ng-binding">账户结算</span></a></li>
                            </ul>
                        </div>
                        <div class="sidebar-nav sidebar-nav-fold">
                            ...
                            <ul style="" class="entrance-nav sidebar-trans">
                                <li class="nav-item ng-scope"    title="检测报告" src="/WebUI/FinanceMan/DetectRepord_List.aspx?rnd=<%=YaohuaID.GenRandomInt()%>"><a href="javascript:void(0)" class="sidebar-trans ng-scope"><div class="nav-icon sidebar-trans"><span class="icon-form"></span> </div><span class="nav-title ng-binding">检测报告</span></a></li>
                            </ul>
                        </div>
                         <div class="sidebar-nav sidebar-nav-fold">
                            ...
                            <ul style="" class="entrance-nav sidebar-trans">
                            <li class="nav-item ng-scope"    title="消息通知" src="/WebUI/FinanceMan/NewsInform_List.aspx?rnd=<%=YaohuaID.GenRandomInt()%>"><a href="javascript:void(0)" class="sidebar-trans ng-scope"><div class="nav-icon sidebar-trans"><span class="icon-form"></span> </div><span class="nav-title ng-binding">消息通知</span></a></li>
                            </ul>
                        </div>
                        <div class="sidebar-nav sidebar-nav-fold">
                            ...
                            <ul style="" class="entrance-nav sidebar-trans">
                            <li class="nav-item ng-scope"    title="个人信息" src="/WebUI/FinanceMan/PeosonInfo_List.aspx?rnd=<%=YaohuaID.GenRandomInt()%>"><a href="javascript:void(0)" class="sidebar-trans ng-scope"><div class="nav-icon sidebar-trans"><span class="icon-form"></span> </div><span class="nav-title ng-binding">个人信息</span></a></li>
                            </ul>
                        </div>
                    </div>
