<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LanOrderGoodList.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.LanOrderGoodList" ValidateRequest="false" %>
...
<h4>LAN订单明细列表(共<asp:Label ID="listcount" runat="server" Text="0" ForeColor="#0099CC"></asp:Label>条数据)</h4>
</div>
