...
{
public partial class SysCorpModify : System.Web.UI.Page
{
...
if (!IsPostBack)
{
////SysCorpModifyDataInit方法之前
DataInit();
////SysCorpModifyDataInit方法之后
////SysCorpModifyBind方法之前
{
Bind();
}
}
////初始化实体
////SysCorpModifyInitEntity方法之前
InitEntity();
////SysCorpModifyInitEntity方法之后
}
...
{
Response.Redirect("SysCorp_Detail.aspx?&id="+HttpUtility.UrlEncode(Request["id"])+"&rnd="+YaohuaID.GenRandomInt()+"&query="+HttpUtility.UrlEncode(Request["query"])+"");
}
////初始化实体
InitEntity();
}
...
////初始化实体
InitEntity();
////SysCorpModify初始化替换代码之前
tbCoreCode.Text=entity.CoreCode.ToStr();
tbCorpName.Text=entity.CorpName.ToStr();
////SysCorpModify初始化替换代码之后
}
...
////必须克隆不然会影响缓存数据
entity = entity.Clone();
////SysCorpModify初始化InitEntity
////添加附加按钮代码
if (entity._CustomCode == null)
entity = Yaohuasoft.Framework.BLL.SysAdmin.SysCorpBLL.GetCustomCode(entity);
}
}
//////SysCorpModify自定义事件替换1
//////SysCorpModify自定义事件替换2
//////SysCorpModify自定义事件替换3
//////SysCorpModify自定义事件替换4
//////SysCorpModify自定义事件替换5
//////SysCorpModify自定义事件替换6
...
////SysCorpModify赋值之后保存
////SysCorpModify保存的处理之前
{
////SysCorpModify保存Save方法之前
var ret = Yaohuasoft.Framework.BLL.SysAdmin.SysCorpBLL.Save(entity ,Session["CorpId"].ToStr(),Session["DepartmentId"].ToStr(),Session["UserName"].ToStr());
if (ret > 0){
...
errormsg.Text = "保存出错，请重新保存！";
 ...
 {
 string id = hiddenID.Value.ToString();
 ////SysCorpModifyDelete按钮赋值之前
////SysCorpModify删除按钮处理之前
{
////SysCorpModify删除方法之前
