<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="LanCarousel_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.LanCarouselModify" %>
<%@ Import Namespace="Yaohuasoft.Framework.Library" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<title>修改LAN轮播图 | </title>
...
<h4 class="txt_title" style="float: left">编辑LAN轮播图</h4>
...
<a class="btn btn-primary" href="javascript:window.location.href='LanCarousel_Detail.aspx?rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>&id=<%=HttpUtility.UrlEncode(Request["id"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="" colspan ="3"><span class="col_name">图片：</span><input type="hidden" name="hidden_fileLanCarouselImg" class=""/><UC:UC_PluploadSingle PageType ="可写" ID="fileLanCarouselImg" runat="server" /><b></b></td><td  title ="" colspan ="3"><span class="col_name">图片名称：</span><asp:TextBox ID="tbLanCarouselName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
