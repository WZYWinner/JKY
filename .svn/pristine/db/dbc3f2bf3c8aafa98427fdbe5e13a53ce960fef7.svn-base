...
{
public partial class LxcGoodsCreate : System.Web.UI.Page
{
...
{
////CheckSession();
////LxcGoodsCreateDataInit方法之前
DataInit();
////LxcGoodsCreateDataInit方法之后
}
}
...
{
////只会执行一次
var entity = new LxcGoodsDALEntity();
////LxcGoodsCreate初始化替换代码之前
////LxcGoodsCreate初始化替换代码之后
////LxcGoodsCreate初始化自动填充之前
////LxcGoodsCreate初始化自动填充之后
}
//////LxcGoodsCreate自定义事件替换1
//////LxcGoodsCreate自定义事件替换2
//////LxcGoodsCreate自定义事件替换3
//////LxcGoodsCreate自定义事件替换4
//////LxcGoodsCreate自定义事件替换5
//////LxcGoodsCreate自定义事件替换6
...
////LxcGoodsCreate赋值之后保存
////LxcGoodsCreate保存的处理之前
{
////LxcGoodsCreate保存Add方法之前
var ret = Yaohuasoft.Framework.BLL.SysAdmin.LxcGoodsBLL.Add(entity,Session["CorpId"].ToStr(),Session["DepartmentId"].ToStr(),Session["UserName"].ToStr());
if (ret > 0)
{
