<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="OrderDetail_Create.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.WzyAdmin.OrderDetailCreate" %>
