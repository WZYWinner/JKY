<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="SysMenu_Create.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.SysMenuCreate" %>
...
<h4 class="txt_title" style="float: left">新增系统菜单</h4>
