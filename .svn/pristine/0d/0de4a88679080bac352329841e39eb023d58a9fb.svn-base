<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="GuoUser_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.GsfAdmin.GuoUserModify" %>
...
<h4 class="txt_title" style="float: left">编辑郭用户</h4>
...
<a class="btn btn-primary" href="javascript:window.location.href='GuoUser_Detail.aspx?&id=<%=HttpUtility.UrlEncode(Request["id"])%>&rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="用户名" colspan ="3"><span class="col_name">用户名：</span><asp:TextBox ID="tbUserName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="密码" colspan ="3"><span class="col_name">密码：</span><asp:TextBox ID="tbPassword" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr> <td  title ="电话" colspan ="3"><span class="col_name">电话：</span><asp:TextBox ID="tbTelephone" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="地址" colspan ="3"><span class="col_name">地址：</span><asp:TextBox ID="tbAddress" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
