<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="SysCorp_Create.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.SysCorpCreate" %>
...
<h4 class="txt_title" style="float: left">新增客户公司</h4>
