<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="LanAddress_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.LanAddressModify" %>
...
<a class="btn btn-primary" href="javascript:window.location.href='LanAddress_Detail.aspx?rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>&id=<%=HttpUtility.UrlEncode(Request["id"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="" colspan ="3"><span class="col_name">用户ID：</span><asp:TextBox ID="tbSysUserId" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="" colspan ="3"><span class="col_name">收货人：</span><asp:TextBox ID="tbLanAddressUsername" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr> <td  title ="" colspan ="3"><span class="col_name">收货人电话：</span><asp:TextBox ID="tbLanAddressPhone" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="" colspan ="3"><span class="col_name">收货地址：</span><asp:TextBox ID="tbLanAddressName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
