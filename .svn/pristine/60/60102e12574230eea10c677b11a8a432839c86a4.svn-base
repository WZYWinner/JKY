<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="GuoGoods_Upload.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.GuoGoodsUpload" %>
