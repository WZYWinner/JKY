<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="LxcGoods_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.LxcGoodsModify" %>
...
<h4 class="txt_title" style="float: left">编辑商城商品</h4>
...
<a class="btn btn-primary" href="javascript:window.location.href='LxcGoods_Detail.aspx?rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>&id=<%=HttpUtility.UrlEncode(Request["id"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="" colspan ="3"><span class="col_name">商品名称：</span><asp:TextBox ID="tbLxcGoodsName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="" colspan ="3"><span class="col_name">商品价格：</span><asp:TextBox ID="tbLxcGoodsPrice" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr> <td  title ="" colspan ="2"><span class="col_name">商品图片：</span><input type="hidden" name="hidden_fileLxcGoodsPic" class=""/><UC:UC_PluploadSingle PageType ="可写" ID="fileLxcGoodsPic" runat="server" /><b></b></td><td  title ="" colspan ="2"><span class="col_name">商品数量：</span><asp:TextBox ID="tbLxcGoodsNum" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="" colspan ="2"><span class="col_name">商品子图片：</span><input type="hidden" name="hidden_filesLxcGoodsPics" class=""/><UC:UC_Plupload IsPicMode="true" PageType="读写" ID="filesLxcGoodsPics" runat="server" /><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
