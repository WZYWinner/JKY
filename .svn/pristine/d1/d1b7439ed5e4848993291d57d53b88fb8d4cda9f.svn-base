<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="GuoUser_Create.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.GuoUserCreate" %>
...
<h4 class="txt_title" style="float: left">新增郭用户</h4>
