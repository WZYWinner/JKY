<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="GuoGoods_Create.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.GuoGoodsCreate" %>
...
<h4 class="txt_title" style="float: left">新增商品</h4>
