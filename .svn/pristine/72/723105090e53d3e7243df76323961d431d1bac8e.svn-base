<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="SysUser_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.LqAdmin.SysUserModify" %>
