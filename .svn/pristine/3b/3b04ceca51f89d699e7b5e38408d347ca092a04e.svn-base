<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderDetailList.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.OrderDetailList" ValidateRequest="false" %>
...
<h4>订单明细列表(共<asp:Label ID="listcount" runat="server" Text="0" ForeColor="#0099CC"></asp:Label>条数据)</h4>
</div>
...
<th style="    min-width: 80px;">商品小计</th>
 </tr>
 </thead>
 <tbody>
