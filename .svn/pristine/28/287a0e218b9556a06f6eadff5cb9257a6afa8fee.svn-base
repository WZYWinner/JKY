<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="GoodsSort_Create.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.GoodsSortCreate" %>
