<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="GuoGoods_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.GsfAdmin.GuoGoodsModify" %>
...
<h4 class="txt_title" style="float: left">编辑商品</h4>
...
<a class="btn btn-primary" href="javascript:window.location.href='GuoGoods_Detail.aspx?&id=<%=HttpUtility.UrlEncode(Request["id"])%>&rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="商品名" colspan ="3"><span class="col_name">商品名：</span><asp:TextBox ID="tbGoodsName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="商品价格" colspan ="3"><span class="col_name">商品价格：</span><asp:TextBox ID="tbGoodsPrice" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr> <td  title ="商品数量" colspan ="2"><span class="col_name">商品数量：</span><asp:TextBox ID="tbGoodsNum" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="商品图" colspan ="2"><span class="col_name">商品图：</span><asp:TextBox ID="tbGoodsImg" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="标签" colspan ="2"><span class="col_name">标签：</span><asp:TextBox ID="tbLaber" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
