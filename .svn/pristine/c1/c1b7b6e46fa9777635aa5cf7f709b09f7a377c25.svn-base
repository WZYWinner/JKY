<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="GuoMerchant_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.GuoMerchantModify" %>
