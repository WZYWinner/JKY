<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="LxcSubmit_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.LxcSubmitModify" %>
...
<h4 class="txt_title" style="float: left">编辑提交订单</h4>
...
<a class="btn btn-primary" href="javascript:window.location.href='LxcSubmit_Detail.aspx?rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>&id=<%=HttpUtility.UrlEncode(Request["id"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="" colspan ="3"><span class="col_name">商品名称：</span><asp:TextBox ID="tbLxcSubmitName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="" colspan ="3"><span class="col_name">商品价格：</span><asp:TextBox ID="tbLxcSubmitPrice" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr> <td  title ="" colspan ="2"><span class="col_name">商品图片：</span><input type="hidden" name="hidden_fileLxcSubmitPic" class=""/><UC:UC_PluploadSingle PageType ="可写" ID="fileLxcSubmitPic" runat="server" /><b></b></td><td  title ="" colspan ="2"><span class="col_name">商品数量：</span><asp:TextBox ID="tbLxcSubmitNum" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="" colspan ="2"><span class="col_name">下单用户：</span><asp:TextBox ID="tbLxcSubmitAddressName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr> <td  title ="" colspan ="2"><span class="col_name">手机号：</span><asp:TextBox ID="tbLxcSubmitAddressPhone" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="" colspan ="2"><span class="col_name">下单地址：</span><asp:TextBox ID="tbLxcSubmitAddressAdres" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="" colspan ="2"><span class="col_name">下单时间：</span><asp:TextBox ID="tbLxcSubmitAddressTime" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
