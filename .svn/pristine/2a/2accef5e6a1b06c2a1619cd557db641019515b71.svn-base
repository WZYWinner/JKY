...
{
public partial class LanSecondMenuDetail : System.Web.UI.Page
{
...
////LanSecondMenuDetailInitEntity方法之前
////初始化实体
InitEntity();
////LanSecondMenuDetailInitEntity方法之后
}
...
////初始化实体
InitEntity();
this.fileLanSecondMenuImg.UploadUrl=entity.LanSecondMenuImg.ToStr();
}
//////LanSecondMenuDetail自定义事件替换1
//////LanSecondMenuDetail自定义事件替换2
//////LanSecondMenuDetail自定义事件替换3
//////LanSecondMenuDetail自定义事件替换4
//////LanSecondMenuDetail自定义事件替换5
//////LanSecondMenuDetail自定义事件替换6
...
////LanSecondMenuDetailDelete按钮赋值之前
////LanSecondMenuDetail删除按钮处理之前
{
////LanSecondMenuDetail删除方法之前
