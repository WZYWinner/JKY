<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="MerchantClassify_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.LqAdmin.MerchantClassifyModify" %>
...
<tbody>
<tr> <td  title ="商家分类名" colspan ="3"><span class="col_name">商家分类名：</span><asp:TextBox ID="tbSortName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="商家分类LOGO" colspan ="3"><span class="col_name">商家分类LOGO：</span><asp:TextBox ID="tbSortImg" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
