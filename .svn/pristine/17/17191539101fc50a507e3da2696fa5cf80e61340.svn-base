<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuoMerchantList.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.GuoMerchantList" ValidateRequest="false" %>
