<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="GoodsClassify_Create.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.LqAdmin.GoodsClassifyCreate" %>
