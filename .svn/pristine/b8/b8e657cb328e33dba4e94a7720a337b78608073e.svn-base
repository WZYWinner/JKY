<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="SysDelete_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.SysDeleteModify" %>
...
<h4 class="txt_title" style="float: left">编辑数据回收站</h4>
...
<a class="btn btn-primary" href="javascript:window.location.href='SysDelete_Detail.aspx?rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>&id=<%=HttpUtility.UrlEncode(Request["id"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="删除ID" colspan ="2"><span class="col_name">删除ID：</span><asp:TextBox ID="tbDelId" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="源数据ID" colspan ="2"><span class="col_name">源数据ID：</span><asp:TextBox ID="tbDataId" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="数据类型" colspan ="2"><span class="col_name">数据类型：</span><asp:DropDownList ID="tbDataType" runat="server" CssClass=""></asp:DropDownList><b></b></td> </tr>
<tr> <td  title ="数据内容JSON" colspan ="3"><span class="col_name">数据内容JSON：</span><asp:TextBox ID="tbDataJson" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="删除时间" colspan ="3"><span class="col_name">删除时间：</span><asp:TextBox ID="tbDelTime" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
