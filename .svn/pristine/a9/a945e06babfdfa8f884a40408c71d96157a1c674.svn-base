<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="GuoUser_Upload.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.GuoUserUpload" %>
