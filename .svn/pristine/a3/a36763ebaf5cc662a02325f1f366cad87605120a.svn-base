<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="GoodsClassify_Create.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.GoodsClassifyCreate" %>
...
<h4 class="txt_title" style="float: left">新增商品分类</h4>
