<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="SysCorp_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.SysCorpModify" %>
...
<h4 class="txt_title" style="float: left">编辑客户公司</h4>
...
<a class="btn btn-primary" href="javascript:window.location.href='SysCorp_Detail.aspx?&id=<%=HttpUtility.UrlEncode(Request["id"])%>&rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="" colspan ="3"><span class="col_name">公司单位代码：</span><asp:TextBox ID="tbCoreCode" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="客户公司名" colspan ="3"><span class="col_name">客户公司名：</span><asp:TextBox ID="tbCorpName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
