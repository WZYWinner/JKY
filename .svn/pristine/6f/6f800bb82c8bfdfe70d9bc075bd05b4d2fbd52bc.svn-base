<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="WangLoser_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.WangLoserModify" %>
...
<h4 class="txt_title" style="float: left">编辑王用户</h4>
...
<a class="btn btn-primary" href="javascript:window.location.href='WangLoser_Detail.aspx?&id=<%=HttpUtility.UrlEncode(Request["id"])%>&rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="" colspan ="2"><span class="col_name">ID：</span><asp:TextBox ID="tbWangLoserId" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="用户名" colspan ="2"><span class="col_name">用户名：</span><asp:TextBox ID="tbWangLoserName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="密码" colspan ="2"><span class="col_name">密码：</span><asp:TextBox ID="tbWangLoserPassword" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr> <td  title ="地址" colspan ="3"><span class="col_name">地址：</span><asp:TextBox ID="tbWangLoserAddress" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="手机号码" colspan ="3"><span class="col_name">手机号：</span><asp:TextBox ID="tbWangLoserTel" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
