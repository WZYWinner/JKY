<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="LxcSubmit_Create.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.LxcSubmitCreate" %>
...
<h4 class="txt_title" style="float: left">新增提交订单</h4>
