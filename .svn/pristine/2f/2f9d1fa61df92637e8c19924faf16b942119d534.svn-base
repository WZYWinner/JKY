<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="MerchantList_Upload.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.LqAdmin.MerchantListUpload" %>
