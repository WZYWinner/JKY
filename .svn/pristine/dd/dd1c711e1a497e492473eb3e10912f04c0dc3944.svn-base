<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="SysUser_Create.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.GsfAdmin.SysUserCreate" %>
...
<h4 class="txt_title" style="float: left">新增后台用户</h4>
...
<tbody>
<tr> <td  title ="用户帐号" colspan ="6"><span class="col_name"><em>*</em>用户帐号：</span><asp:TextBox ID="tbUserName" MaxLength="200" runat="server" CssClass="tbox {required:true} " ></asp:TextBox><b></b></td> </tr>
<tr>  </tr>
