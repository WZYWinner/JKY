<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="GoodsRecommend_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.GoodsRecommendModify" %>
...
<h4 class="txt_title" style="float: left">编辑商品推荐</h4>
...
<a class="btn btn-primary" href="javascript:window.location.href='GoodsRecommend_Detail.aspx?rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>&id=<%=HttpUtility.UrlEncode(Request["id"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="" colspan ="3"><span class="col_name">商品ID：</span><asp:TextBox ID="tbGoodsId" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="" colspan ="3"><span class="col_name">商品名称：</span><asp:TextBox ID="tbGoodsName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr> <td  title ="" colspan ="2"><span class="col_name">商品图片：</span><input type="hidden" name="hidden_fileGoodsPic" class=""/><UC:UC_PluploadSingle PageType ="可写" ID="fileGoodsPic" runat="server" /><b></b></td><td  title ="" colspan ="2"><span class="col_name">推荐时长：</span><asp:TextBox ID="tbLength" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="" colspan ="2"><span class="col_name">推荐位置：</span><asp:TextBox ID="tbPosition" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr>  </tr>
</tbody>
</table>
</div>
