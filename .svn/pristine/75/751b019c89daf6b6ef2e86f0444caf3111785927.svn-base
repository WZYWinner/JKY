<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="SysDepartment_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.SysDepartmentModify" %>
...
<h4 class="txt_title" style="float: left">编辑部门</h4>
...
<a class="btn btn-primary" href="javascript:window.location.href='SysDepartment_Detail.aspx?rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>&id=<%=HttpUtility.UrlEncode(Request["id"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="公司" colspan ="6"><span class="col_name">公司：</span><asp:DropDownList ID="tbCorpId" runat="server" CssClass=""></asp:DropDownList><b></b></td> </tr>
<tr> <td  title ="" colspan ="3"><span class="col_name">部门代码：</span><asp:TextBox ID="tbDepartmentCode" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="部门名" colspan ="3"><span class="col_name">部门名：</span><asp:TextBox ID="tbDepartmentName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr>  </tr>
</tbody>
</table>
</div>
