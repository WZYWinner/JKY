<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="SysDelete_Create.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.SysDeleteCreate" %>
...
<h4 class="txt_title" style="float: left">新增数据回收站</h4>
