...
<%--                        <div class="sidebar-nav main-nav">
                        ...
                        <div class="sidebar-nav sidebar-nav">
                            ...
                            <ul style="" class="entrance-nav sidebar-trans">
                                ...
                                <li class="nav-item ng-scope"    title="地区" src="/WebUI/SysAdmin/SysArea_List.aspx?rnd=<%=YaohuaID.GenRandomInt()%>"><a href="javascript:void(0)" class="sidebar-trans ng-scope"><div class="nav-icon sidebar-trans"><span class="icon-form"></span> </div><span class="nav-title ng-binding">地区</span></a></li>
                               </ul>
                        </div>
