<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="GoodsRecommend_Create.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.GoodsRecommendCreate" %>
...
<h4 class="txt_title" style="float: left">新增商品推荐</h4>
