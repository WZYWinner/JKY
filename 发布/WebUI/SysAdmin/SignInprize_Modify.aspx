<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="SignInprize_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.SignInprizeModify" %>
...
<h4 class="txt_title" style="float: left">编辑签到有奖</h4>
...
<a class="btn btn-primary" href="javascript:window.location.href='SignInprize_Detail.aspx?rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>&id=<%=HttpUtility.UrlEncode(Request["id"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="" colspan ="3"><span class="col_name">用户ID：</span><asp:TextBox ID="tbUserId" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="" colspan ="3"><span class="col_name">积分等级：</span><asp:TextBox ID="tbSignGrade" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr> <td  title ="" colspan ="2"><span class="col_name">总积分：</span><asp:TextBox ID="tbSignCount" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="" colspan ="2"><span class="col_name">连续签到天数：</span><asp:TextBox ID="tbContinuityDay" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="" colspan ="2"><span class="col_name">签到总计天数：</span><asp:TextBox ID="tbSignDayCount" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr> <td  title ="" colspan ="3"><span class="col_name">积分奖励：</span><asp:TextBox ID="tbIntegral" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="" colspan ="3"><span class="col_name">签到时间：</span><asp:TextBox ID="tbSignTime" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr>  </tr>
</tbody>
</table>
</div>
