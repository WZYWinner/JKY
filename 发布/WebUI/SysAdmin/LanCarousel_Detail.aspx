<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LanCarousel_Detail.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.LanCarouselDetail" %>
<%@ Import Namespace="Yaohuasoft.Framework.Library" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<title>LAN轮播图详情 | </title>
...
<h4 class="txt_title" style="float: left">查看LAN轮播图</h4>
...
<%--自定义Detail的按钮标签之前--%>
<a class="btn btn-primary" hidefocus="" href="LanCarousel_Modify.aspx?rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>&id=<%=HttpUtility.UrlEncode(Request["id"])%>" >编辑</a>
...
<tbody>
<tr> <td  title ="" colspan ="3"><span class="col_name">图片：</span><input type="hidden" name="hidden_fileLanCarouselImg" class=""/><UC:UC_PluploadSingle PageType ="只读" ID="fileLanCarouselImg" runat="server" /></td><td  title ="" colspan ="3"><span class="col_name">图片名称：</span><%=HttpUtility.HtmlEncode(entity.LanCarouselName.ToStr()) %></td> </tr>
</tbody>
</table>
</div>
</div>
