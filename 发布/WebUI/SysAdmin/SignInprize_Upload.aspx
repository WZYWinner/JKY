<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="SignInprize_Upload.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.SignInprizeUpload" %>
<%@ Import Namespace="Yaohuasoft.Framework.Library" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<title>EXCEL导入签到有奖 | </title>
...
<h4 class="txt_title" style="float: left">导入签到有奖</h4>
<div class="btn_left" style="overflow: hidden; float: left; margin-left: 30px"><a class="btn btn-primary" href="javascript:window.location.href='SignInprize_List.aspx?rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>&id=<%=HttpUtility.UrlEncode(Request["id"])%>'" name="del">返回</a></div>
</small>
</div>
