<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysDepartment_Detail.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.SysDepartmentDetail" %>
...
<h4 class="txt_title" style="float: left">查看部门</h4>
...
<%--自定义Detail的按钮标签之前--%>
<a class="btn btn-primary" hidefocus="" href="SysDepartment_Modify.aspx?rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>&id=<%=HttpUtility.UrlEncode(Request["id"])%>" >编辑</a>
...
<tbody>
<tr> <td  title ="公司" colspan ="6"><span class="col_name">公司：</span><%=HttpUtility.HtmlEncode(entity.CorpId.ToStr()) %></td> </tr>
<tr> <td  title ="" colspan ="3"><span class="col_name">部门代码：</span><%=HttpUtility.HtmlEncode(entity.DepartmentCode.ToStr()) %></td><td  title ="部门名" colspan ="3"><span class="col_name">部门名：</span><%=HttpUtility.HtmlEncode(entity.DepartmentName.ToStr()) %></td> </tr>
<tr>  </tr>
</tbody>
</table>
</div>
