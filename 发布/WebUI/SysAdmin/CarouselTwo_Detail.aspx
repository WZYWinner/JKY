<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarouselTwo_Detail.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.CarouselTwoDetail" %>
...
<h4 class="txt_title" style="float: left">查看轮播图二</h4>
...
<%--自定义Detail的按钮标签之前--%>
<a class="btn btn-primary" hidefocus="" href="CarouselTwo_Modify.aspx?rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>&id=<%=HttpUtility.UrlEncode(Request["id"])%>" >编辑</a>
