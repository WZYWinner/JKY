<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="MzqGoods_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.MzqGoodsModify" %>
...
<a class="btn btn-primary" href="javascript:window.location.href='MzqGoods_Detail.aspx?rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>&id=<%=HttpUtility.UrlEncode(Request["id"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="" colspan ="3"><span class="col_name">卖家：</span><asp:TextBox ID="tbMzqGoodsSeller" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="" colspan ="3"><span class="col_name">商品名称：</span><asp:TextBox ID="tbMzqGoodsName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr> <td  title ="" colspan ="3"><span class="col_name">商品价格：</span><asp:TextBox ID="tbMzqGoodsPrice" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="" colspan ="3"><span class="col_name">商品图片：</span><input type="hidden" name="hidden_fileMzqGoodsPic" class=""/><UC:UC_PluploadSingle PageType ="可写" ID="fileMzqGoodsPic" runat="server" /><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
