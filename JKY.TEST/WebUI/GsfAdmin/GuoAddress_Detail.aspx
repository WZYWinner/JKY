<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuoAddress_Detail.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.GsfAdmin.GuoAddressDetail" %>
...
<h4 class="txt_title" style="float: left">查看郭地址</h4>
...
<%--自定义Detail的按钮标签之前--%>
<a class="btn btn-primary" hidefocus="" href="GuoAddress_Modify.aspx?&rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>&id=<%=HttpUtility.UrlEncode(Request["id"])%>" >编辑</a>
