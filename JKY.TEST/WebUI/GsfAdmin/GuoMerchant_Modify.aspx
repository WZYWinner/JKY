<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="GuoMerchant_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.GsfAdmin.GuoMerchantModify" %>
...
<h4 class="txt_title" style="float: left">编辑商家</h4>
...
<a class="btn btn-primary" href="javascript:window.location.href='GuoMerchant_Detail.aspx?&id=<%=HttpUtility.UrlEncode(Request["id"])%>&rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="商家名字" colspan ="3"><span class="col_name">商家名字：</span><asp:TextBox ID="tbMerchantName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="商家图片" colspan ="3"><span class="col_name">商家图片：</span><asp:TextBox ID="tbMerchantImg" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr> <td  title ="商家配送" colspan ="3"><span class="col_name">商家配送：</span><asp:TextBox ID="tbMerchantDelivery" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="标签" colspan ="3"><span class="col_name">标签：</span><asp:TextBox ID="tbLaber" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
