<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuoUserList.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.GsfAdmin.GuoUserList" ValidateRequest="false" %>
...
// 绑定事件
url='GuoUser_Detail.aspx?&id=' + encodeURIComponent($(obj).parent().attr('dateid')) + '&rnd=<%=YaohuaID.GenRandomInt()%>&query=' + encodeURIComponent($('#QueryString').val())+'';
}
...
<th style="    min-width: 80px;">地址</th>
 ...
 <ItemTemplate>
 <tr dateid="<%#Eval("GuoUserId") %>" class="data_list">
 <td class="ck">
 <asp:CheckBox ID="chkSelect" runat="server" />
 <asp:HiddenField ID="hiddenID" runat="server" Value='<%# Eval("GuoUserId") %>' />
 </td>
...
<a class="btn btn-primary" href="GuoUser_Upload.aspx?&rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>">导入</a>
