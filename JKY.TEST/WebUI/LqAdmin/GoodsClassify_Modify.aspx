<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="GoodsClassify_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.LqAdmin.GoodsClassifyModify" %>
...
<tbody>
<tr> <td  title ="商品分类名" colspan ="3"><span class="col_name">商品分类名：</span><asp:TextBox ID="tbSortName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="商品分类ID" colspan ="3"><span class="col_name">商品分类ID：</span><asp:TextBox ID="tbMerchantListId" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
