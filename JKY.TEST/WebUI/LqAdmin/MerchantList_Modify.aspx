<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="MerchantList_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.LqAdmin.MerchantListModify" %>
...
<tbody>
<tr> <td  title ="商家名称" colspan ="3"><span class="col_name">商家名称：</span><asp:TextBox ID="tbMerchantName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="商家LOGO" colspan ="3"><span class="col_name">商家LOGO：</span><asp:TextBox ID="tbMerchantLogo" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
