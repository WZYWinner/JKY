<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsList_Detail.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.LqAdmin.GoodsListDetail" %>
...
<tbody>
<tr> <td  title ="商品名" colspan ="3"><span class="col_name">商品名：</span><%=HttpUtility.HtmlEncode(entity.GoodsName.ToStr()) %></td><td  title ="商品图片" colspan ="3"><span class="col_name">商品图片：</span><%=HttpUtility.HtmlEncode(entity.GoodsLogo.ToStr()) %></td> </tr>
