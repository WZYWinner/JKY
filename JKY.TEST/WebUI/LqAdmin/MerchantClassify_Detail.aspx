<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MerchantClassify_Detail.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.LqAdmin.MerchantClassifyDetail" %>
...
<tbody>
<tr> <td  title ="商家分类名" colspan ="3"><span class="col_name">商家分类名：</span><%=HttpUtility.HtmlEncode(entity.SortName.ToStr()) %></td><td  title ="商家分类LOGO" colspan ="3"><span class="col_name">商家分类LOGO：</span><%=HttpUtility.HtmlEncode(entity.SortImg.ToStr()) %></td> </tr>
</tbody>
</table>
</div>
</div>
