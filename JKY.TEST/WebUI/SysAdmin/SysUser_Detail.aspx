<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysUser_Detail.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.SysUserDetail" %>
...
<a class="btn btn-primary" onclick="btn_pop('修改密码','ModifyPassword.aspx?&id=<%=HttpUtility.UrlEncode(Request["id"])%>&Entity=SysUser','40%','35%')">修改密码</a>
