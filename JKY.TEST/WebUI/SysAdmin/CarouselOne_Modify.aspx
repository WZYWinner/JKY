<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="CarouselOne_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.CarouselOneModify" %>
...
<h4 class="txt_title" style="float: left">编辑轮播图一</h4>
...
<a class="btn btn-primary" href="javascript:window.location.href='CarouselOne_Detail.aspx?rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>&id=<%=HttpUtility.UrlEncode(Request["id"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="" colspan ="3"><span class="col_name">卖家名称：</span><asp:TextBox ID="tbSeller" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="" colspan ="3"><span class="col_name">广告图片：</span><input type="hidden" name="hidden_fileAdPic" class=""/><UC:UC_PluploadSingle PageType ="可写" ID="fileAdPic" runat="server" /><b></b></td> </tr>
<tr> <td  title ="" colspan ="6"><span class="col_name">广告文字信息：</span><asp:TextBox ID="tbAdText" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
