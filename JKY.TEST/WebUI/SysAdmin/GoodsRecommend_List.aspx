<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsRecommendList.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.GoodsRecommendList" ValidateRequest="false" %>
...
// 绑定事件
url='GoodsRecommend_Detail.aspx?rnd=<%=YaohuaID.GenRandomInt()%>&id=' + encodeURIComponent($(obj).parent().attr('dateid')) + '&query=' + encodeURIComponent($('#QueryString').val())+'';
}
...
<th style="">最近修改时间</th>
 ...
 <td class="c_point" _url="" _Color="" _Key="" onclick="javascript:pic_list_click(this)" ><span> <%#HttpUtility.HtmlEncode(Eval("Length").ToStrCn()) %> </span></td>
 <td class="c_point" _url="" _Color="" _Key="" onclick="javascript:pic_list_click(this)" ><span> <%#HttpUtility.HtmlEncode(Eval("Position").ToStrCn()) %> </span></td>
...
<a class="btn btn-primary" href="GoodsRecommend_Upload.aspx?rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>">导入</a>
