<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="MerchantClassify_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.MerchantClassifyModify" %>
...
<h4 class="txt_title" style="float: left">编辑商家分类</h4>
...
<a class="btn btn-primary" href="javascript:window.location.href='MerchantClassify_Detail.aspx?&id=<%=HttpUtility.UrlEncode(Request["id"])%>&rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="商家分类ID" colspan ="2"><span class="col_name">商家分类ID：</span><asp:TextBox ID="tbMerchantSortId" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="商家分类名" colspan ="2"><span class="col_name">商家分类名：</span><asp:TextBox ID="tbSortName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="商家分类LOGO" colspan ="2"><span class="col_name">商家分类LOGO：</span><asp:TextBox ID="tbSortImg" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
