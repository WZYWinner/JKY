<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LanSecondMenuList.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.LanSecondMenuList" ValidateRequest="false" %>
...
<h4>菜单明细列表(共<asp:Label ID="listcount" runat="server" Text="0" ForeColor="#0099CC"></asp:Label>条数据)</h4>
</div>
