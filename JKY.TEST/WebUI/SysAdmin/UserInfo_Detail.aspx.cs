...
////UserInfoDetailInitEntity方法之前
////初始化实体
InitEntity();
////UserInfoDetailInitEntity方法之后
}
...
////初始化实体
InitEntity();
this.fileHead.UploadUrl=entity.Head.ToStr();
}
//////UserInfoDetail自定义事件替换1
//////UserInfoDetail自定义事件替换2
//////UserInfoDetail自定义事件替换3
//////UserInfoDetail自定义事件替换4
//////UserInfoDetail自定义事件替换5
//////UserInfoDetail自定义事件替换6
...
////UserInfoDetailDelete按钮赋值之前
////UserInfoDetail删除按钮处理之前
{
////UserInfoDetail删除方法之前
