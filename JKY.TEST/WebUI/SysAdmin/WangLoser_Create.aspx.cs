...
{
public partial class WangLoserCreate : System.Web.UI.Page
{
...
if (!IsPostBack)
{
////WangLoserCreateDataInit方法之前
DataInit();
////WangLoserCreateDataInit方法之后
}
}
...
{
////只会执行一次
var entity = new WangLoserDALEntity();
////WangLoserCreate初始化替换代码之前
////WangLoserCreate初始化替换代码之后
////WangLoserCreate初始化自动填充之前
////WangLoserCreate初始化自动填充之后
}
//////WangLoserCreate自定义事件替换1
//////WangLoserCreate自定义事件替换2
//////WangLoserCreate自定义事件替换3
//////WangLoserCreate自定义事件替换4
//////WangLoserCreate自定义事件替换5
//////WangLoserCreate自定义事件替换6
...
////WangLoserCreate赋值之后保存
////WangLoserCreate保存的处理之前
{
////WangLoserCreate保存Add方法之前
var ret = Yaohuasoft.Framework.BLL.SysAdmin.WangLoserBLL.Add(entity,Session["CorpId"].ToStr(),Session["DepartmentId"].ToStr(),Session["UserName"].ToStr());
if (ret > 0)
{
