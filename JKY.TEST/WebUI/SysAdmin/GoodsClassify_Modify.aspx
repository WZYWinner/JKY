<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="GoodsClassify_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.GoodsClassifyModify" %>
...
<h4 class="txt_title" style="float: left">编辑商品分类</h4>
...
<a class="btn btn-primary" href="javascript:window.location.href='GoodsClassify_Detail.aspx?&id=<%=HttpUtility.UrlEncode(Request["id"])%>&rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="商品分类ID" colspan ="2"><span class="col_name">商品分类ID：</span><asp:TextBox ID="tbGoodsSortId" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="商品分类名" colspan ="2"><span class="col_name">商品分类名：</span><asp:TextBox ID="tbSortName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="商品分类ID" colspan ="2"><span class="col_name">商品分类ID：</span><asp:TextBox ID="tbMerchantListId" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
