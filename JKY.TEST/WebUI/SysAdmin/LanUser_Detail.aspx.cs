...
{
public partial class LanUserDetail : System.Web.UI.Page
{
...
////LanUserDetailInitEntity方法之前
////初始化实体
InitEntity();
////LanUserDetailInitEntity方法之后
}
...
////初始化实体
InitEntity();
this.fileLanUserImg.UploadUrl=entity.LanUserImg.ToStr();
}
//////LanUserDetail自定义事件替换1
//////LanUserDetail自定义事件替换2
//////LanUserDetail自定义事件替换3
//////LanUserDetail自定义事件替换4
//////LanUserDetail自定义事件替换5
//////LanUserDetail自定义事件替换6
...
////LanUserDetailDelete按钮赋值之前
////LanUserDetail删除按钮处理之前
{
////LanUserDetail删除方法之前
