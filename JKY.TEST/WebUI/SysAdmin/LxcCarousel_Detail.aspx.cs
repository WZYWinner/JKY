...
{
public partial class LxcCarouselDetail : System.Web.UI.Page
{
...
////LxcCarouselDetailInitEntity方法之前
////初始化实体
InitEntity();
////LxcCarouselDetailInitEntity方法之后
}
...
////初始化实体
InitEntity();
this.fileLxcCarouselUrl.UploadUrl=entity.LxcCarouselUrl.ToStr();
}
//////LxcCarouselDetail自定义事件替换1
//////LxcCarouselDetail自定义事件替换2
//////LxcCarouselDetail自定义事件替换3
//////LxcCarouselDetail自定义事件替换4
//////LxcCarouselDetail自定义事件替换5
//////LxcCarouselDetail自定义事件替换6
...
////LxcCarouselDetailDelete按钮赋值之前
////LxcCarouselDetail删除按钮处理之前
{
////LxcCarouselDetail删除方法之前
