<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarouselOneList.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.CarouselOneList" ValidateRequest="false" %>
...
// 绑定事件
url='CarouselOne_Detail.aspx?rnd=<%=YaohuaID.GenRandomInt()%>&id=' + encodeURIComponent($(obj).parent().attr('dateid')) + '&query=' + encodeURIComponent($('#QueryString').val())+'';
}
...
<th style="">最近修改时间</th>
 ...
 <td class="c_point" _url="" _Color="" _Key="" onclick="javascript:pic_list_click(this)" ><span> <%#HttpUtility.HtmlEncode(Eval("AdPic").ToStrCn()) %> </span></td>
 <td class="c_point" _url="" _Color="" _Key="" onclick="javascript:pic_list_click(this)" ><span> <%#HttpUtility.HtmlEncode(Eval("AdText").ToStrCn()) %> </span></td>
...
<a class="btn btn-primary" href="CarouselOne_Upload.aspx?rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>">导入</a>
