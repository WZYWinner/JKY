<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="LxcAddress_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.LxcAddressModify" %>
...
<a class="btn btn-primary" href="javascript:window.location.href='LxcAddress_Detail.aspx?rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>&id=<%=HttpUtility.UrlEncode(Request["id"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="" colspan ="3"><span class="col_name">用户名：</span><asp:TextBox ID="tbLxcAddressName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="" colspan ="3"><span class="col_name">手机号：</span><asp:TextBox ID="tbLxcAddressPhone" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr> <td  title ="" colspan ="3"><span class="col_name">收货地址：</span><asp:TextBox ID="tbLxcAddressAdres" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="" colspan ="3"><span class="col_name">收货状态：</span><asp:TextBox ID="tbLxcAddressStatus" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
