<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="LxcUser_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.LxcUserModify" %>
...
<h4 class="txt_title" style="float: left">编辑用户登录</h4>
...
<a class="btn btn-primary" href="javascript:window.location.href='LxcUser_Detail.aspx?rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>&id=<%=HttpUtility.UrlEncode(Request["id"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="" colspan ="3"><span class="col_name">账号：</span><asp:TextBox ID="tbUserName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="" colspan ="3"><span class="col_name">密码：</span><asp:TextBox ID="tbUserPasswd" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
<tr> <td  title ="" colspan ="6"><span class="col_name">账户注册时间：</span><asp:TextBox ID="tbUserTime" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
