<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="SysMenu_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.SysMenuModify" %>
...
<h4 class="txt_title" style="float: left">编辑系统菜单</h4>
...
<a class="btn btn-primary" href="javascript:window.location.href='SysMenu_Detail.aspx?rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>&id=<%=HttpUtility.UrlEncode(Request["id"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="中文名" colspan ="3"><span class="col_name">中文名：</span><asp:TextBox ID="tbCnName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="权重" colspan ="3"><span class="col_name">权重：</span><asp:TextBox ID="tbPowerIndex" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
