...
{
public partial class MzqShoppingcarDetail : System.Web.UI.Page
{
...
////MzqShoppingcarDetailInitEntity方法之前
////初始化实体
InitEntity();
////MzqShoppingcarDetailInitEntity方法之后
}
...
////初始化实体
InitEntity();
this.fileMzqShoppingcarPic.UploadUrl=entity.MzqShoppingcarPic.ToStr();
}
//////MzqShoppingcarDetail自定义事件替换1
//////MzqShoppingcarDetail自定义事件替换2
//////MzqShoppingcarDetail自定义事件替换3
//////MzqShoppingcarDetail自定义事件替换4
//////MzqShoppingcarDetail自定义事件替换5
//////MzqShoppingcarDetail自定义事件替换6
...
////MzqShoppingcarDetailDelete按钮赋值之前
////MzqShoppingcarDetail删除按钮处理之前
{
////MzqShoppingcarDetail删除方法之前
