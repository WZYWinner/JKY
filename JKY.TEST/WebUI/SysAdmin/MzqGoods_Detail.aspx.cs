...
{
public partial class MzqGoodsDetail : System.Web.UI.Page
{
...
////MzqGoodsDetailInitEntity方法之前
////初始化实体
InitEntity();
////MzqGoodsDetailInitEntity方法之后
}
...
////初始化实体
InitEntity();
this.fileMzqGoodsPic.UploadUrl=entity.MzqGoodsPic.ToStr();
}
//////MzqGoodsDetail自定义事件替换1
//////MzqGoodsDetail自定义事件替换2
//////MzqGoodsDetail自定义事件替换3
//////MzqGoodsDetail自定义事件替换4
//////MzqGoodsDetail自定义事件替换5
//////MzqGoodsDetail自定义事件替换6
...
////MzqGoodsDetailDelete按钮赋值之前
////MzqGoodsDetail删除按钮处理之前
{
////MzqGoodsDetail删除方法之前
