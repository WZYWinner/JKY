<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuoOrderForm_Detail.aspx.cs" Inherits="Yaohuasoft.Framework.WebUI.SysAdmin.GuoOrderFormDetail" %>
...
<%--自定义Detail的按钮标签之前--%>
<a class="btn btn-primary" hidefocus="" href="GuoOrderForm_Modify.aspx?&rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>&id=<%=HttpUtility.UrlEncode(Request["id"])%>" >编辑</a>
