<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="MerchantSort_Modify.aspx.cs" Inherits=" Yaohuasoft.Framework.WebUI.SysAdmin.MerchantSortModify" %>
...
<a class="btn btn-primary" href="javascript:window.location.href='MerchantSort_Detail.aspx?&id=<%=HttpUtility.UrlEncode(Request["id"])%>&rnd=<%=YaohuaID.GenRandomInt()%>&query=<%=HttpUtility.UrlEncode(Request["query"])%>'" name="del">返回</a>
...
<tbody>
<tr> <td  title ="分类名字" colspan ="3"><span class="col_name">分类名字：</span><asp:TextBox ID="tbSortName" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td><td  title ="分类图片" colspan ="3"><span class="col_name">分类图片：</span><asp:TextBox ID="tbSortImg" MaxLength="200" runat="server" CssClass="tbox  " ></asp:TextBox><b></b></td> </tr>
</tbody>
</table>
</div>
</div>
