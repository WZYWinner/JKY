<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LqAdmin.aspx.cs" Inherits="UI.DEMO.LqAdmin" %>
...
<li class="nav-item ng-scope" title="刘用户" src="/WebUI/LqAdmin/LiuUser_List.aspx?&rnd=<%=YaohuaID.GenRandomInt()%>"><a class="ng-scope" href="javascript:void(0)"><div class="nav-icon"><span class="icon-yunxunizhuji"></span></div><span class="nav-title ng-binding">刘用户</span></a></li>
                            </ul>
                        </div>
...
<%--                           <div class="sidebar-title" title="个人用户管理">
            ...
            <div class="viewFramework-product">
                ...
                <div class="viewFramework-product-body">
                    <iframe id="mainFrame" frameborder="0" runat="server" src="LqAdminHomePage.aspx" style="height: 100%; width: 100%; border: 0px;"></iframe>
                </div>
            </div>
        </div>
    </div>
