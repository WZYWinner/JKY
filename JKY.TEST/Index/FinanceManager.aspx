<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinanceManager.aspx.cs" Inherits="UI.DEMO.FinanceManager" %>
            ...
            <div class="aliyun-console-topbar ng-isolate-scope">
                <div class="topbar-wrap topbar-clearfix">
                    <div class="topbar-head topbar-left">
                        ...
                        <!-- ngIf: versionGreaterThan1_3_21 -->
                        <a href="javascript:showRight('FinanceManagerHomePage.aspx')" class="topbar-home-link topbar-btn topbar-left ng-scope">
