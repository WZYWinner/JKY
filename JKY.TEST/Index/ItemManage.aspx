<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemManage.aspx.cs" Inherits="UI.DEMO.ItemManage" %>
            ...
            <div class="aliyun-console-topbar ng-isolate-scope">
                <div class="topbar-wrap topbar-clearfix">
                    <div class="topbar-head topbar-left">
                        ...
                        <!-- ngIf: versionGreaterThan1_3_21 -->
                        <a href="javascript:showRight('ItemManageHomePage.aspx')" class="topbar-home-link topbar-btn topbar-left ng-scope">
